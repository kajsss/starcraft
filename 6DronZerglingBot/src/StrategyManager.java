...
public class StrategyManager {
	...
	public void executeCombat() {
		...
		if (isFullScaleAttackStarted == false) {
			...
			// MyBotModule.Broodwar.getFrameCount() >= 2300
	...
	void saveGameRecordList(boolean isWinner) {
		...
		// TODO : 파일명은 각자 봇 명에 맞게 수정하시기 바랍니다
		String gameRecordFileName = "C:\\Starcraft\\bwapi-data\\write\\6DronRushBot.dat";
	...
	void saveGameLog() {
		...
		// TODO : 파일명은 각자 봇 명에 맞게 수정하시기 바랍니다
		String gameLogFileName = "C:\\Starcraft\\bwapi-data\\write\\6DronRushBot_LastGameLog.dat";
